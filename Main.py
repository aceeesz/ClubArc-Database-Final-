...
class ClubPage(QMainWindow):
    def __init__(self):
        ...
        self.settingsButton.clicked.connect(self.gotoSettingsPage)
        self.IMGBackground.setPixmap(QPixmap("BackgroundImage.png"))
        self.IMGAddClub.setPixmap(QPixmap("ClubCreate.png"))
        self.IMGDeleteClub.setPixmap(QPixmap("ClubDelete.png"))
        self.IMGUpdateClub.setPixmap(QPixmap("ClubUpdate.png"))
    ...
    def clrButtonClub(self):
        ...
        self.addClubResult.setText("Cleared Data")
    ...
    def deleteClub(self):
        ...
        try:
            ...
            if searchResult[-1][-1] == 1:
                ...
                cursor.execute("DELETE FROM Advisers WHERE Club_ID = ?", (clubID,))  
...
class MembersPage(QMainWindow):
    def __init__(self):
        ...
        self.settingsButton.clicked.connect(self.gotoSettingsPage)
        self.IMGBackground.setPixmap(QPixmap("BackgroundImage.png"))
        self.IMGAddPeople.setPixmap(QPixmap("UserProfile.png"))
        self.IMGDeletePeople.setPixmap(QPixmap("PeopleDelete.png"))
    ...
    def clrButtonMembers(self):
        ...
        self.addMemberResult.setText("Cleared Data")
...
class AdvisersPage(QMainWindow):
    def __init__(self):
        ...
        self.settingsButton.clicked.connect(self.gotoSettingsPage)
        self.IMGBackground.setPixmap(QPixmap("BackgroundImage.png"))
        self.IMGAddAdviser.setPixmap(QPixmap("AdviserCreate.png"))
        self.IMGDeleteAdviser.setPixmap(QPixmap("AdviserDelete.png"))
...
class MembershipPage(QMainWindow):
    def __init__(self):
        ...
        self.settingsButton.clicked.connect(self.gotoSettingsPage)
        self.IMGBackground.setPixmap(QPixmap("BackgroundImage.png"))
        self.IMGAddMembership.setPixmap(QPixmap("MembershipCreate.png"))
        self.IMGDeleteMembership.setPixmap(QPixmap("MembershipDelete.png"))
...
class Settings(QMainWindow):
    def __init__(self):
        ...
        self.IMGBackground.setPixmap(QPixmap("BackgroundImage.png"))
        self.IMGWarning.setPixmap(QPixmap("Warning.png"))
